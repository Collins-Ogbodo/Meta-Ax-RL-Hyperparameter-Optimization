...
#env = CantileverEnv_v0_1(_env_gen_kwargs)
...
settings = {
    'wandb_project': "cantilever-ax-hpo-Mode-6_4-Sensors-HPC-Result-Evaluate-2-",
    'model_name': "ppo-cantilever-Mode-6_4-Sensors-HPC-Result-Evaluate-2",
    'ax_experiment_name': "ppo-cantilever-experiment-Mode-6_4-Sensors-HPC-Result-Evaluate-2",
    'ax_objective_name': "avg_ep_rew",
    'replay_buffer_name': None,
    'save_dir': "ppo-cantilever-checkpoints-Mode-6_4-Sensors-Result-Evaluate-2",
...
hparams = {
    'n_envs': 1,
    'learning_rate': 0.00013026619908433002,
    'steps_per_update_pow2': 7,
    'batch_size_div_pow2': 2,
    'entropy_coef': 0,
    "gamma" : 0.988126456481882,
    "layer_1_pow2" : 7,
    "layer_2_pow2" : 5,
    }
